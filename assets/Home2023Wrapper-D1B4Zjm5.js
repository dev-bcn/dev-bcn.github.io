...
`,be=()=>{const{hash:s}=$();return D.useEffect(()=>{if(s!=null&&s!==""){const n=document.getElementById(s.substring(1));n==null||n.scrollIntoView()}},[s]),U("Home",m.edition),e.jsxs(we,{id:"home-wrapper",children:[e.jsx(de,{}),e.jsx(Z,{}),e.jsx(F,{speakersLink:G,sessionizeUrl:m.edition,isEnabled:m.carrousel.enabled}),e.jsx(he,{})]})};export{be as Home2023Wrapper,be as default};
//# sourceMappingURL=Home2023Wrapper-D1B4Zjm5.js.map
