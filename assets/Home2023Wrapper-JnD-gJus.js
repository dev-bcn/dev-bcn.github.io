import{h as t,x as a,e as i,p as o,j as e,r as m,q as w,l as j,S as u,aN as y,M as v,n as p,B as g,aO as k,aP as S,aM as _,f as B,ad as E,ae as C,af as T,ag as I,ah as L,ai as A,aj as R,ak as $,v as D,g as U,am as F,aQ as G}from"./index-DtwnEVd4.js";import{c as l}from"./2023-B5vIzsTA.js";try{let s=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{},n=new s.Error().stack;n&&(s._sentryDebugIds=s._sentryDebugIds||{},s._sentryDebugIds[n]="8b76fe2e-f22a-4612-a522-4baca65b116d",s._sentryDebugIdIdentifier="sentry-dbid-8b76fe2e-f22a-4612-a522-4baca65b116d")}catch{}const N=t(a.section)`
  display: flex;
...
`,H=t.div.withConfig({shouldForwardProp:s=>!["padding"].includes(s)})`
  position: relative;
  @media (min-width: 800px) {
    height: auto;
...
`,V=({faq:s,index:n})=>{const d=n%2===0;return e.jsxs(P,{className:"faq-card",children:[e.jsx(H,{padding:d?"0 1rem 0 0":"0 0 0 1rem",children:e.jsx(m.Suspense,{fallback:e.jsx(w,{src:"/images/logo.svg"}),children:e.jsx(J,{src:`images/2023/FaqsImage${n}.png`})})}),e.jsxs(M,{align:d?"flex-start":"flex-end",children:[e.jsx(W,{children:s.question}),e.jsx(Y,{children:s.answer})]})]})},Z=()=>{const{width:s}=j();return e.jsxs(e.Fragment,{children:[e.jsx(u,{color:i.DARK_BLUE,children:e.jsxs(N,{children:[y.map((n,d)=>e.jsx(V,{faq:n,index:d},n.id)),e.jsx("div",{id:"last-jbcnconf",children:" "}),e.jsxs("div",{style:{width:"60%"},children:[e.jsx(O,{children:"Check last JBCNConf edition"}),e.jsx(m.Suspense,{fallback:e.jsx(w,{src:"/images/logo.svg"}),children:e.jsx(x,{src:"images/jbcnconf/jbcnconf-1.jpg",alt:"JBCNConf"})}),e.jsx(m.Suspense,{fallback:e.jsx(w,{src:"/images/logo.svg"}),children:e.jsx(x,{src:"images/jbcnconf/jbcnconf-2.jpg",alt:"JBCNConf - Keynote"})}),e.jsx(b,{children:"DevBcn is the rebranding of the biggest Java & JVM conference in Spain, now including more technologies and tracks."}),e.jsx(b,{children:"Check for videos/photos and summary of the JBCNConf - 2022 edition"}),e.jsx("a",{href:"https://www.flickr.com/photos/barcelonajug/collections/72157720937175671/",rel:"noreferrer",target:"_blank",children:e.jsx("img",{src:"/images/flickr.svg",alt:"flickr",height:32,width:32})}),e.jsx("a",{href:"https://www.youtube.com/watch?v=zFPpwRyl4Iw&list=PLo0fJV3LkR3z42GevLgXlQfNFP2qfgtrq",rel:"noreferrer",target:"_blank",children:e.jsx("img",{src:"/images/youtube.svg",alt:"Youtube",height:32,width:32})}),e.jsx("a",{href:"https://docs.google.com/presentation/d/1t1RnYOqcoP8Bo1GVyiGyW-mY_2bBpUspnW8nqXDUbGI/edit?usp=sharing",rel:"noreferrer",target:"_blank",children:e.jsx("img",{src:"/images/slides.png",alt:"Summary Slides",height:32,width:32})})]}),s>v&&e.jsxs(e.Fragment,{children:[e.jsx(q,{src:"/images/LessThanBlueWhiteIcon.svg"}),e.jsx(K,{src:"/images/LessThanBlueIcon.svg"})]})]})}),e.jsx(z,{children:e.jsx("svg",{viewBox:"0 0 500 150",preserveAspectRatio:"none",style:{height:"100%",width:"100%"},children:e.jsx("path",{d:"M0.00,49.98 C335.50,45.89 358.63,106.09 501.41,81.42 L500.00,150.00 L0.00,150.00 Z",style:{stroke:"none",fill:"#4798CA"}})})})]})},Q=t.div`
  padding: 70px 0 40px;
...
`,re=()=>{const s=m.useCallback(()=>{p("attendee-info","attendee-infos")},[]),n=m.useCallback(()=>{p("speaker-info","speaker-info")},[]);return e.jsxs(oe,{children:[e.jsx(g,{onClick:s,target:"_self",text:"🙋🏻 Attendee information",link:k}),e.jsx(g,{onClick:n,target:"_self",text:"🎙️ Speaker information",link:S})]})},me=t.div`
  display: flex;
  text-align: center;
...
`,be=()=>{const{hash:s}=$();return D.useEffect(()=>{if(s!=null&&s!==""){const n=document.getElementById(s.substring(1));n==null||n.scrollIntoView()}},[s]),U("Home",l.edition),e.jsxs(we,{id:"home-wrapper",children:[e.jsx(de,{}),e.jsx(Z,{}),e.jsx(F,{speakersLink:G,sessionizeUrl:l.edition,isEnabled:l.carrousel.enabled}),e.jsx(he,{})]})};export{be as Home2023Wrapper,be as default};
//# sourceMappingURL=Home2023Wrapper-JnD-gJus.js.map
