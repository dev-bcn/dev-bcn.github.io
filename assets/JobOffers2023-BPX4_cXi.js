import{d as r,j as e,C as a,M as l}from"./index-DXiv3G0H.js";import{S as s,C as d,a as c,b as p,c as u,d as m}from"./CompanyOffers-Bowf08Rg.js";import{T as g}from"./TitleSection-BP-pos9W.js";import{S as h}from"./SectionWrapper-BQH1UnIl.js";import{c as o}from"./2023-NYqJTeaB.js";import{u as f}from"./useDocumentTitleUpdate-BIe_dlbe.js";import"./Linkedin-DOKW94Ih.js";import"./Twitter-BwmJ-hXI.js";(function(){try{var i=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{};i.SENTRY_RELEASE={id:"5f3fe988cdd87c5a67d6afd8ac398c5e9a8fc0d5"}}catch{}})();try{(function(){var i=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{},n=new i.Error().stack;n&&(i._sentryDebugIds=i._sentryDebugIds||{},i._sentryDebugIds[n]="3aaf39c8-6ce7-441c-8e8b-b0b2fd67affe",i._sentryDebugIdIdentifier="sentry-dbid-3aaf39c8-6ce7-441c-8e8b-b0b2fd67affe")})()}catch{}const t=[{name:"GFT",id:"4a399a19-7455-4953-94ce-76f59d40c032",description:"GFT is a digital transformation pioneer that develops sustainable solutions based on new technologies including artificial intelligence and blockchain/DLT. GFT experts create and implement scalable software applications that make access to innovative business models safe and easy.",logo:"/images/sponsors/GFT.jpg",url:"https://www.gft.com",linkedin:"https://www.linkedin.com/company/gft-group/",twitter:"https://twitter.com/gft_es",offers:[{id:"9ccccac9-561c-4d3e-ad7d-a7331f88511b",title:"Senior DevOps Engineer",url:"https://jobs.gft.com/job-invite/111948/",location:"Hybrid",text:`<p>We are looking for an enthusiastic and dynamic person willing to work as a Senior Devops Engineer and interested to be part of an international project. </p>
<p>Your main responsibilities will be:</p>
<ul><li> Standardize, automate and document setup of development, testing and production environments.</li>
...
<ul><li>Bachelor's Degree in Computer Science, Engineer or related field.</li>
...
</ul>`},{id:"92796dbf-db15-487b-a728-939b14ae442c",title:"Java Specialist",url:"https://jobs.gft.com/job-invite/111946/",location:"Hybrid",text:`<p>We are looking for an enthusiastic and dynamic person willing to work as a Java (Spring and Spring Boot).Your main responsibilities will be:</p>
<ul><li>Participates on the different backend development cycle stages, including UAT and Go Live, at the corresponding level, starting the project from scratch.</li>
...
</li><li>Understanding of the ""rules of development"" (Code management, code repository, continuous Integration – CI and code review).</li>
</ul>
<p>Skills will help you to succeed:</p>
<ul><li>Bachelor's Degree in Computer Science, Engineer or related field.</li>
...
</ul>`},{id:"ac0bbe94-6526-43d8-a655-ed8e19d19203",title:"Front End Specialist",location:"Hybrid",url:"https://jobs.gft.com/job-invite/111978/",text:`<p>We are looking for an enthusiastic and dynamic person willing to work as a Front End Specialist (mainly React).</p>
<p>Your main responsibilities will be</p>
<ul><li>Development of web applications with the latest versions of the main frameworks and libraries based on requirements and detailed specifications.</li>
...
<li>Agile methodologies.</li>
<li>At least B2 level of English</li>
</ul>`},{id:"22bd4bd6-ad6a-4bce-a733-7c4ac812af58",title:"Big Data Engineer",location:"Hybrid",url:"https://jobs.gft.com/job-invite/10463/",text:`<p>Buscamos Big Data Engineers que quieran desarrollar su carrera profesional en el sector TI. ¿Quieres unirte a nuestro equipo de GFT?</p>
...
<ul><li>Licenciatura o Grado en Ingeniería de Software o similares.</li>
...
<ul><li>Conocimiento de soluciones No-SQL (HBase, Elastic, Cassandra, MongoDB); Conocimientos de soluciones data basadas en cloud (GCP, AWS, IBM Watson, Azure...); Comprensión de algoritmos de machine learning.</li>
<li>Conocimiento en transformación de datos o ETL.</li>
</ul>`},{id:"83907cfc-028d-4485-b2c5-fecf1516effd",title:"API Architect",url:"",location:"Hybrid",text:`<p>We are looking for an enthusiastic and dynamic API Architect.</p>
<p>Your main responsibilities will be:</p>
<ul>
...
<ul><li>Computer Science diploma, 6+ years of relevant work experience </li>
...
<li>Fluency in English (at least B2 level</li>)</ul>`},{id:"6bda67ef-4b8f-476b-bb21-2f7a87e0d670",location:"Hybrid",title:"Google Cloud Platform Engineer",url:"https://jobs.gft.com/job-invite/99121/",text:`<p>Actualmente tenemos un puesto vacante para un/a Google Cloud Platform (GCP) Engineer que quiera unirse a GFT en nuestros proyectos internacionales. </p>
<p>Tus principales responsabilidades serán:</p>
<ul>
...
<p>Requisitos:</p>
<ul><li>Excelente conocimiento de los distintos entornos Cloud, especialmente GCP.</li>
...
</ul>`},{id:"72a02498-9417-475d-97e0-59f3a82a56b3",location:"Hybrid",title:"Desarrollador/a Java Microservicios",url:"https://jobs.gft.com/job-invite/2121/",text:`<p>Actualmente tenemos un puesto vacante para un/a Desarrollador/a Senior Java con Microservicios que quiera desarollar su carrera en GFT.  </p>
...
<p>Requisitos deseados:</p>
<ul><li>Graduado en Ingeniería informática (o equivalente).</li>
...
`}]},{name:"Idealista",id:"9b68e783-12c0-4c23-bffc-96d2c65cdcdb",logo:"/images/sponsors/idealista.jpg",description:"Idealista is the main meeting point for all those people who are looking for a home (or premises, building, the list goes on...) either to buy or to rent, and for those who sell or rent out these properties.",url:"https://www.idealista.com/info/trabaja-con-nosotros",linkedin:"https://www.linkedin.com/company/idealista-com/",twitter:"https://www.linkedin.com/idealista",offers:[{id:"e31a1eb2-46e9-4214-9b17-387398d122ac",title:"Backend Developer ",url:"https://www.linkedin.com/jobs/view/3566480528",location:"Full remote",text:`<p>¿Eres un apasionado de la programación?</p><p>Buscamos a chicos y chicas con ganas de crecer de profesionalmente, con pasión por la programación y las tecnologías
  para integrarse en nuestro equipo de desarrollo en nuestras oficinas situadas en pleno centro de Madrid ;)</p>
<p>¿Qué
  te ofrecemos?</p><p>Si disfrutas programando, superando retos y aprendiendo todos los días, entonces te ofrecemos
  pasarlo muy bien!</p>
...
<ul>
  ...
  <li> Plan de retribución flexible.</li><li> Formación inicial y continuada.</li></ul>
<p>Requisitos importantes para trabajar con nosotros!</p>
<ul><li> Ganas de aprender y pasión por la programación.
...
</ul><p>Otras cosas que valoramos muy positivamente.</p>
<ul><li> Experiencia en desarrollo para CRMs o ERPs internos o externos</li>
...
<p>Te estamos esperando</p>`}]},{name:"Sopra Steria",id:"bf3871fa-9423-4370-8b12-e8e5112fec24",logo:"/images/sponsors/sopra.jpg",url:"https://www.soprasteria.com",description:"We are a European leader in digital transformation, providing one of the most comprehensive portfolios of end-to-end service offerings on the market: Consulting, Systems Integration, Software Development, Infrastructure Management and Business Process Services.",linkedin:"https://www.linkedin.com/company/soprasteria",offers:[{id:"939d0ff8-2ecf-41a9-abff-81349f3b7d5c",title:"Full Stack Javascript Engineer",location:"Full remote",url:"https://www.soprasteria.com/",text:`<p>Our employees agree on the 𝗚𝗿𝗲𝗮𝘁 𝗧𝗲𝗮𝗺 and environment we have at 𝗦𝗼𝗽𝗿𝗮 𝗦𝘁𝗲𝗿𝗶𝗮. We are more than 46,000 people working in 25 countries and our mission is to match talent and technology, trying to help you find a place where you can develop your full potential.</p>
...
`}]},{name:"King",id:"d7235281-9424-4d15-b7a3-fba26d4178dc",description:"King is a leading interactive entertainment company for the mobile gaming world.",twitter:"https://twitter.com/king_games?lang=en",linkedin:"https://www.linkedin.com/company/king/",url:"https://careers.king.com/",logo:"/images/sponsors/king.png",offers:[{id:"47778f29-27b7-4783-a5d9-5d1faa2e1ab7",url:"https://careers.king.com/jobs/job/r020701-cplusplus-tools-engineer/",location:"Hybrid",title:"C++ Tools Engineer",text:`<p>We are looking for an experienced Game Engine Tools Engineer to join our custom cross platform mobile game engine team. Our engine and toolchain is used by hundreds of developers inside of King and is used to deliver some of the biggest games in the world. Our team is made up of 45 dedicated people, and we are now looking to grow by adding experienced engineers with great customer centric approaches.
...
<li>Self- driving attitude combined with passion for improving users workflows and solving difficult challenges are key skills for this role.</li></ul></p>`}]},{name:"Allianz Technology",id:"2dcb4f7e-94e3-402e-b56f-0b9f67a4d319",description:`With its headquarters in Munich and more than 11,000 employees
...
customer experience.`,url:"https://tech.allianz.com/en.html",linkedin:"https://www.linkedin.com/company/allianz-technology/",logo:"/images/sponsors/allianz.png",offers:[{id:"1a281437-fcb3-4e8a-bc87-eae711f4a95b",title:"Frontend/ Fullstack Developer",location:"Barcelona",text:`<p>Are you thinking of next steps in your career path? You deserve a
...
<p> As a SW Developer Fullstack, you will be creating reusable UI
...
<li> Open and international working environment.</li></ul>`,url:"Frontend/ Fullstack Developer"}]},{name:"Alten",id:"31c93b3f-f534-4a5f-9684-e9a0c388e636",url:"https://www.alten.es/",logo:"/images/sponsors/alten.png",linkedin:"https://www.linkedin.com/company/alten-spain/mycompany/",description:"ALTEN is a multinational company that has positioned itself among the first consulting companies providing global experiences, important partners and quality in its ideas, responses and teams.",offers:[{id:"ba12fbbe-d337-4bc8-bd80-b0e34d231aed",title:"Senior Java/Javascript Architect",location:"Full remote",text:`<p>At ALTEN we are building, today, the world of tomorrow and we need someone to contribute to this goal. </p>
How?<ul>
...
<p>If you are the leader we are looking for, we will be glad to welcome you on board!</p>`,url:"https://www.alten.es/career/5169-senior-java-javascript-architect-teletrabajo/"}]},{name:"Gradle",id:"fc2e69c0-0efc-40df-a535-c7b2df646a5e",logo:"/images/sponsors/gradle.png",description:"We are the providers of the Gradle Enterprise build and test performance acceleration and failure analytics solution to improving developer productivity and the Gradle Build Tool.",url:"gradle.com",offers:[{title:"Senior Frontend Engineer",location:"Full remote",id:"485f2976-b1c4-4308-a02b-548a767f547b",text:`<p>We are looking for senior front-end engineers with a demonstrated ability to efficiently deliver and maintain robust and useful front-end solutions, as part of a collaborative team.</p>
...
</ul>`,url:"https://grnh.se/8d97b88b1us"},{title:"Developer Productivity Engineer",id:"58f8098a-89a6-4949-833c-66eeaa484f8d",location:"Full remote",url:"https://grnh.se/05c9a98a1us",text:`<p>We are looking for a passionate Developer Productivity Engineer with a demonstrated ability to accelerate developer productivity through optimizing speed and reliability of feedback cycles and increasing the degree of automation.</p+>
...
<li>Implementing and improving monitoring of developer productivity metrics</li></ul>`},{title:"Developer Advocate",id:"86e4cfee-2464-49a1-94d4-6d7d5f224afc",location:"Full remote",url:"https://grnh.se/8d26ab5d1us",text:`<p>We are looking for a Developer Advocate for Gradle Build Tool. The person in this role will focus on sharing knowledge and fostering the community through high-traffic online channels as well as in person.</p>
...
`}]},{name:"New Relic",id:"8e13e80b-e3c1-4710-9ff0-5d6d391e05fb",description:"Full-Stack Observability helps engineers plan, build, deploy, and run great software. Only New Relic has a unified data platform for all telemetry data—metrics, events, logs and traces—paired with analysis tools to find solutions fast. Move past the ‘what’ to uncover the ‘why’.",url:"https://newrelic.com/",twitter:"https://twitter.com/newrelic?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor",linkedin:"https://www.linkedin.com/company/new-relic-inc-/",logo:"/images/sponsors/someRelic.png",offers:[{title:"Senior Frontend Software Engineer (New Relic One platform - Open to remote)",id:"08cb9887-4317-4d9f-98af-f7b715b86606",location:"Full remote",url:"https://newrelic.careers/en_US/careers/JobDetail/Senior-Frontend-Software-Engineer-New-Relic-One-platform-Open-to-remote/3561",text:`<p><strong>Your opportunity</strong></p>
...
<li>Learn and improve your skills to continuously push us to deliver higher-quality tools and improve the UI team's workflows.</li></ul>`}]},{name:"Adaptive",id:"04b05cf9-d07c-425f-8368-4972f69ebcd9",description:"At Adaptive, we partner with capital and commodity market participants that value differentiation through technology. Our experienced teams design and deliver complex solutions, using our proven accelerators, creating a long-term competitive advantage for our clients.",twitter:"https://www.twitter.com/WeAreAdaptive",linkedin:"www.linkedin.com/company/adaptive-consulting-ltd/",url:"weareadaptive.com",logo:"/images/sponsors/adaptive.png",offers:[{id:"1190b4cf-17bb-4b22-8d07-882b012b95c8",title:"Software Engineer",location:"Hybrid",url:"https://hub.weareadaptive.com/devbcn_job_offers",text:`<p>We are not hiring at the moment, but that doesn't mean we will not be hiring next month!</p>
...
<p>Let's keep in touch!</p>`}]},{name:"Capitole",id:"e3f6c467-8b6d-4077-aced-14d0a8a3f508",description:"At Capitole we empower businesses to reach their full potential by leveraging cutting-edge and innovative IT services, while valuing people every step of the way.",url:"https://capitole-consulting.com/",linkedin:"https://www.linkedin.com/company/capitole-consulting/",logo:"/images/sponsors/capitole.png",offers:[{title:"Technical Lead",location:"hybrid",url:"https://www.linkedin.com/company/capitole-consulting/jobs/",text:`<p>En Capitole Consulting buscamos un Technical Lead que le apasione el mundo de la programación, que se sienta atraído por los retos y desafíos porque... este es un GRAN RETO 😎 y, sobre todo, que tengan ganas de crecer...Te apuntas??</p>
...
</ul><p>🧐 ¿Qué podemos ofrecemos?</p><ul>
...
<li>¡Por último y no menos importante un EQUIPAZO!</li></ul>`,id:"a80df426-776c-4137-baa2-ea36df384263"}]},{name:"Adevinta",id:"68a85584-6cf7-45f8-82c2-7edce28e259b",url:"www.adevinta.com",logo:"/images/sponsors/adevinta.png",twitter:"https://twittere.com/Adevinta",linkedin:"https://www.linkedin.com/company/adevinta/",description:"We are a global online classifieds specialist, operating digital online classifieds in 11 countries. We provide technology-based services to connect buyers and sellers and facilitate transactions, from job offers to real estate, cars, consumer goods and more.",offers:[{title:"Backend Platform - Generalist",id:"50bfb969-f39b-4ea0-a849-b0bbb622be7d",location:"hybrid",text:`<p>We are looking for a back-end engineer to fulfill our team's back-end platform engineer position for the milanuncios vertical.</p>
...
</ul>"`,url:"https://marketplaces.wd3.myworkdayjobs.com/es/External_Careers/job/Barcelona---Oficina-Central/Backend-Platform---Generalist_JR003429-1"},{title:"iOS Engineer",id:"20b1245f-28ef-4c08-bffa-70d38e39ad35",text:`<p>We are looking for an iOS Engineer to join one of our product teams at coches.net</p>
<p>What are you going to find?</p>
<ul>
<li>A Swift code base with Clean + MVVM architecture.</li>
<li>Crash-free users above 99%.</li><li>CI/CD with Bitrise.</li>
...
<li>Fluent in business Spanish and English (written and spoken).</li></ul>`,location:"Hybrid",url:"https://marketplaces.wd3.myworkdayjobs.com/es/External_Careers/job/Barcelona/iOS-Engineer_JR003627"},{title:"Machine Learning Engineer",id:"aa94fa79-b8bf-4f8e-aff5-d0b67e37c983",location:"Hybrid",url:"https://marketplaces.wd3.myworkdayjobs.com/es/External_Careers/job/Barcelona---Oficina-Central/Machine-Learning-Engineer_JR003442-1",text:`<p>As a Machine Learning Engineer at Adevinta, you will be at the heart of an effort to utilise our unique combination of data to bring about the next generation of digital products and services. You will have a direct impact on millions of users around the world by building data products.</p>
...
`}]},{name:"Revolut",id:"20309974-2602-4eaa-8199-3fbb902fa88a",description:"People deserve more from their money. More visibility, more control, more freedom.With an arsenal of awesome products that span spending, saving, travel, transfers, investing, exchanging and more, our super app has helped 30+ million customers get more from their money. And we're not done yet.",url:"https://www.revolut.com/working-at-revolut/",twitter:"https://twitter.com/revolutinsider",linkedin:"https://www.linkedin.com/company/5356541/",logo:"/images/sponsors/revolut.png",offers:[{title:"Software Engineer (Backend)",id:"2c7a9b7a-b4a2-4664-b114-d7287906e634",text:"We’re looking for a Backend Engineer that wants to change the world. If you like to work at a steady pace with no surprises, keep scrolling. If you want your work to change the global financial landscape, you might be just who we’re looking for. We have a minimalist approach to using external frameworks, with emphasis on maintainability and fast turnaround with TDD, DDD, and Continuous Integration & Delivery.",location:"Full remote",url:"https://www.revolut.com/careers/position/software-engineer-backend-530d3bfd-bdca-4390-8f8a-bc88ddc1eb51/?utm_source=devbcn_conference&utm_medium=ad&utm_campaign=july_2023_devbcn_conference&utm_id=34&utm_term=&utm_content=backend"},{title:"Software Engineer (Python)",id:"59bc8f7e-6b9c-48b4-a3fd-46a7311ff60e",text:`<p>Our Technology team isn’t here to fix legacy systems – it’s here to build world-class financial products from the ground up.</p>
...
<p>You’ll be working with the toughest and most gifted professionals in Product, Design, Data Science and Engineering, on impactful projects that’ll make our company move forward ⏩</p>`,location:"Full remote",url:"https://www.revolut.com/careers/position/data-scientist-credit-5bfed8c7-9f9d-48e2-8e28-7ecf00ac17a8/?utm_source=devbcn_conference&utm_medium=&utm_campaign=july_2023_devbcn_conference&utm_id=36&utm_term=&utm_content=data%20scientist"}]}],b=()=>e.jsx("h4",{style:{color:a.DARK_BLUE},children:"No job offers available yet"}),y=()=>e.jsxs(e.Fragment,{children:[e.jsx(u,{src:"/images/LessThanBlueIcon.svg"}),e.jsx(m,{src:"/images/MoreThanBlueIcon.svg"})]}),j=()=>{const{width:i}=r();return f("Job Offers",o.edition),e.jsx(h,{color:a.WHITE,marginTop:6,paddingBottom:100,children:e.jsxs("section",{children:[e.jsx(s,{children:e.jsx(g,{title:"JOB OFFERS",subtitle:"Have a look at some opportunities",color:a.BLACK_BLUE})}),i>l&&e.jsx(y,{}),!o.jobOffers.enabled&&e.jsx(b,{}),o.jobOffers.enabled&&e.jsxs("div",{id:"job-offers",children:[e.jsx(d,{id:"companies",children:t.map(n=>e.jsx(c,{href:` #${n.name.replaceAll(" ","-").toLowerCase()}`,children:n.name},n.id))}),e.jsx("div",{id:"offers",children:t.map(n=>e.jsx(p,{company:n},n.id))})]})]})})};export{j as default};
//# sourceMappingURL=JobOffers2023-BPX4_cXi.js.map
