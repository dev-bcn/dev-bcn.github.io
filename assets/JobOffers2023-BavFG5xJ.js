...
<p>You’ll be working with the toughest and most gifted professionals in Product, Design, Data Science and Engineering, on impactful projects that’ll make our company move forward ⏩</p>`,location:"Full remote",url:"https://www.revolut.com/careers/position/data-scientist-credit-5bfed8c7-9f9d-48e2-8e28-7ecf00ac17a8/?utm_source=devbcn_conference&utm_medium=&utm_campaign=july_2023_devbcn_conference&utm_id=36&utm_term=&utm_content=data%20scientist"}]}],b=()=>e.jsx("h4",{style:{color:a.DARK_BLUE},children:"No job offers available yet"}),y=()=>e.jsxs(e.Fragment,{children:[e.jsx(h,{src:"/images/LessThanBlueIcon.svg"}),e.jsx(f,{src:"/images/MoreThanBlueIcon.svg"})]}),S=()=>{const{width:n}=r();return l("Job Offers",o.edition),e.jsx(s,{color:a.WHITE,marginTop:6,paddingBottom:100,children:e.jsxs("section",{children:[e.jsx(p,{children:e.jsx(d,{title:"JOB OFFERS",subtitle:"Have a look at some opportunities",color:a.BLACK_BLUE})}),n>c&&e.jsx(y,{}),!o.jobOffers.enabled&&e.jsx(b,{}),o.jobOffers.enabled&&e.jsxs("div",{id:"job-offers",children:[e.jsx(u,{id:"companies",children:t.map(i=>e.jsx(m,{href:` #${i.name.replaceAll(" ","-").toLowerCase()}`,children:i.name},i.id))}),e.jsx("div",{id:"offers",children:t.map(i=>e.jsx(g,{company:i},i.id))})]})]})})};export{S as default};
//# sourceMappingURL=JobOffers2023-BavFG5xJ.js.map
