...
const AttendeeInformation: FC<React.PropsWithChildren<unknown>> = () => {
    ...
    useEffect(() => {
        if (edition) {
            setFormattedDate(format(new Date(edition.startDay), "EEEE, MMMM do"));
            document.title = `Attendee information — ${edition.title} — ${edition.edition}`;
        }
    }, [edition]);
    ...
    return (
        <main>
            ...
            {edition && <p style={{margin: "20px"}}>
                Here's some important information to get the most of your
                attendance to
                DevBcn {edition.edition}.
            </p>}
            <PrePartySection id="pre-party">
                <SectionWrapper>
                    <h2 style={{color: Color.DARK_BLUE}}>Pre-Party</h2>
                    <p style={{textAlign: "justify", margin: "15px"}}>
                        We believe that learning and enjoyment go hand in hand.
                        That's why
                        ...
                        <strong>{formattedDate} from 19:00 to 20:00</strong>.
                        During this
                        time, you can unwind, socialize, and have a great time
                        with fellow
                        participants. Indulge in tasty snacks and beverages
                        while engaging
                        in friendly games of air hockey and table football. It's
                        a fantastic
                        opportunity to network, relax, and set the tone for the
                        upcoming
            ...
            <NetworkingPartySection id="networking-party">
                <SectionWrapper>
                    ...
                    >
                        Only for a selected audience, we'll deliver a networking
                        party with
                        dinner, orchestra, and Karaoke. These tickets will be
                        distributed
                        among the sponsors, and they are they only ones who can
                        provide you
                        one, so make sure to contact them at their booth or
                        through the
                        mobile app throughout the day to get one. They will
                        organize
                        constests and raffles, so make sure to participate in
                        them all to
                ...
                >
                    <div style={{textAlign: "center", fontSize: "16px"}}>
                        ...
                        <p>
                            ...
                            ,<br/>
                            <strong>
                                Make sure to login with the email you provided
                                for your ticket
                            </strong>
                            <img
                                width="100px"
                        ...
                        <p>
                            Get the most out of the app and have a more
                        ...
                        <div style={{
                            ...
                            <div style={{clear: "both"}}>
                                ...
                                <p style={{color: "#2dacee"}}>
                                    <b>NAVIGATE</b> the event agenda and
                                    logistics, even without
                                    Wi-Fi or data. Access useful information
                                    like ridesharing and
                                    local attractions through the Community
                                    Board{" "}
                                </p>
                            </div>
                            <div style={{clear: "both"}}>
                                ...
                                <p style={{color: "#2dacee"}}>
                                    {" "}
                                    <b>NETWORK</b> effectively. Plan whom to
                                    meet by exploring
                                    attendee profiles and sending out
                                    messages{" "}
                                </p>
                            </div>
                            <div style={{clear: "both"}}>
                                ...
                                <p style={{color: "#2dacee"}}>
                                    {" "}
                                    <b>PARTICIPATE</b> in event activities
                                    through session likes,
                                    comments, ratings, live polling, tweeting,
                                    and more{" "}
                                </p>
                            </div>
                        </div>
