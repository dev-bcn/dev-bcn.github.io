...
const Heading = styled.h1`color: ${Color.WHITE};
  font-size: 2.5em;`;
...
export const Diversity: FC = () => {
    ...
    return (<StyledSection className="styled-section">
        ...
        <StyledP className="first">DevBcn, its volunteers, and staff consider that understanding, respecting,
            ...
            in
            our profession.</StyledP>

        <StyledP>That’s why we are running again the diversity sponsorship for
            DevBcn {data.edition} 🎉</StyledP>

        <StyledP>We must thank <a href="https://www.redhat.com/" target="_blank" rel="noreferrer">Red Hat</a> for
            making
            this possible!</StyledP>
