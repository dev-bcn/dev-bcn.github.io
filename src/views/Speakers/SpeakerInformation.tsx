    ...
    <>
      ...
      >
        ...
        >
          ...
          <ul style={{ paddingLeft: "2rem", margin: "1rem" }}>
            <li>
              <strong>17:00 </strong>
              <a
            ...
            <li>
              <strong>18:00 </strong>
              <a
                href="https://www.freixenet.es/es"
                rel="noreferrer"
                target="_blank"
              >
                Cavas Freixenet
            ...
            <li>
              <strong>22:00 </strong>
              <a
                href="https://www.marriott.com/en-us/hotels/bcndm-renaissance-barcelona-hotel/overview/"
                target="_blank"
                rel="noreferrer"
              >
                Hotel Renaissance
      ...
      <svg
        ...
        version="1.1"
      >
        <rect x="0" y="0" width="1280" height="200" fill="#4798CA"></rect>
        <path
          d="M0 139L53.3 139.5C106.7 140 213.3 141 320 140.7C426.7 140.3 533.3 138.7 640 143C746.7 147.3 853.3 157.7 960 157.5C1066.7 157.3 1173.3 146.7 1226.7 141.3L1280 136L1280 201L1226.7 201C1173.3 201 1066.7 201 960 201C853.3 201 746.7 201 640 201C533.3 201 426.7 201 320 201C213.3 201 106.7 201 53.3 201L0 201Z"
          fill="#FFFFFF"
          strokeLinecap="round"
